    ...
    [179], {
        ...
        91078: function (r, n, o) {
            ...
            let Container = class Container extends w.default.Component {
                ...
                componentDidMount() {
                    this.scrollToHash(), l.isSsr && (u.isFallback || u.nextExport && ((0, I.isDynamicRoute)(l.pathname) || location.search || ee) || u.props && u.props.__N_SSG && (location.search || ee)) && l.replace(l.pathname + "?" + String((0, L.assign)((0, L.urlQueryToSearchParams)(l.query), new URLSearchParams(location.search))), s, {
                        _h: 1,
            ...
            function renderError(r) {
                ...
                return console.error(f), console.error("A client-side exception has occurred, see here for more info: https://nextjs.org/docs/messages/client-side-exception-occurred"), d.loadPage("/_error").then(l => {
                    ...
                    return (null == g ? void 0 : g.Component) === u ? Promise.resolve().then(() => S._(o(66908))).then(l => Promise.resolve().then(() => S._(o(21337))).then(o => (n = o.default, r.App = n, l))).then(r => ({
        ...
        22866: function (r, n, o) {
            ...
            let l = o(47425),
                ...
                normalizePathTrailingSlash = r => {
                    ...
                    return /\.[^/]+\/?$/.test(n) ? "" + (0, l.removeTrailingSlash)(n) + o + s : n.endsWith("/") ? "" + n + o + s : n + "/" + o + s
                };
            ("function" == typeof n.default || "object" == typeof n.default && null !== n.default) && void 0 === n.default.__esModule && (Object.defineProperty(n.default, "__esModule", {
                value: !0
            }), Object.assign(n.default, n), r.exports = n.default)
        ...
        32997: function (r, n, o) {
            ...
            async function matchesMiddleware(r) {
                ...
                let {
                    pathname: o
                } = (0, j.parsePath)(r.asPath), l = (0, L.hasBasePath)(o) ? (0, C.removeBasePath)(o) : o, u = (0, I.addBasePath)((0, A.addLocale)(l, r.locale));
                        ...
                        if (!h || f || h.includes("__next_data_catchall") || h.includes("/_error") || h.includes("/404") || (f = h), f) {
                            if (f.startsWith("/")) {
                                ...
                                return Promise.all([o.router.pageLoader.getPageList(), (0, d.getClientBuildManifest)()]).then(s => {
                                    ...
                                    if ((0, b.isDynamicRoute)(y) || !u && d.includes((0, _.normalizeLocalePath)((0, C.removeBasePath)(y), o.router.locales).pathname)) {
                                    ...
                                    let P = d.includes(g) ? g : resolveDynamicRoute((0, _.normalizeLocalePath)((0, C.removeBasePath)(n.pathname), o.router.locales).pathname, d);
            ...
            function handleHardNavigation(r) {
                ...
                if (n === (0, I.addBasePath)((0, A.addLocale)(o.asPath, o.locale))) throw Error("Invariant: attempted to hard navigate to the same URL " + n + " " + location.href);
            ...
            let Router = class Router {
                                ...
                                if (n !== (0, s.removeTrailingSlash)(new URL(this.asPath, "http://n").pathname)) {
                                    ...
                                    if (h || g) {
                                        ...
                                        return handleHardNavigation({
                                            url: (0, I.addBasePath)((0, A.addLocale)(r, o || this.locale, this.defaultLocale)),
                                            router: this
                                        }), new Promise(() => {})
                                    }
                                }
                ...
                async change(r, n, o, l, u) {
                    ...
                    let ee = $.locale; {
                        ...
                        let r = (0, E.parseRelativeUrl)((0, L.hasBasePath)(o) ? (0, C.removeBasePath)(o) : o),
                            u = (0, _.normalizeLocalePath)(r.pathname, this.locales);
                        u.detectedLocale && ($.locale = u.detectedLocale, r.pathname = (0, I.addBasePath)(r.pathname), o = (0, w.formatWithValidation)(r), n = (0, I.addBasePath)((0, _.normalizeLocalePath)((0, L.hasBasePath)(n) ? (0, C.removeBasePath)(n) : n, this.locales).pathname));
                        let s = !1;
                        ...
                        if (!s && d && this.isLocaleDomain && self.location.hostname !== d.domain) {
                            ...
                            handleHardNavigation({
                                url: "http" + (d.http ? "" : "s") + "://" + d.domain + (0, I.addBasePath)(($.locale === d.defaultLocale ? "" : "/" + $.locale) + ("/" === r ? "" : r) || "/"),
                                router: this
                            }), s = !0
                        }
                    ...
                    this._inFlightRoute && this.clc && (Z || Router.events.emit("routeChangeError", buildCancellationError(), this._inFlightRoute, en), this.clc(), this.clc = null), o = (0, I.addBasePath)((0, A.addLocale)((0, L.hasBasePath)(o) ? (0, C.removeBasePath)(o) : o, l.locale, this.defaultLocale));
                    let ea = (0, M.removeLocale)((0, L.hasBasePath)(o) ? (0, C.removeBasePath)(o) : o, $.locale);
                    ...
                    if (K && ep && (Q = !1), Q && "/_error" !== el && (l._shouldResolveHref = !0, ei.pathname = resolveDynamicRoute(el, X), ei.pathname === el || (el = ei.pathname, ei.pathname = (0, I.addBasePath)(el), ep || (n = (0, w.formatWithValidation)(ei)))), !(0, U.isLocalURL)(o)) return handleHardNavigation({
                        url: o,
                        router: this
                    }), !1;
                    es = (0, M.removeLocale)((0, C.removeBasePath)(es), $.locale), ec = (0, s.removeTrailingSlash)(el);
                    let eh = !1;
                    ...
                    try {
                        ...
                        if (K || l.shallow || await this._bfl(o, "resolvedAs" in s ? s.resolvedAs : void 0, $.locale), "route" in s && ep) {
                            ...
                            let r = (0, L.hasBasePath)(ei.pathname) ? (0, C.removeBasePath)(ei.pathname) : ei.pathname;
                            if (eh && el !== r && Object.keys(eh).forEach(r => {
                                    eh && eu[r] === eh[r] && delete eu[r]
                                }), (0, b.isDynamicRoute)(el)) {
                                let r = !en.shallow && s.resolvedAs ? s.resolvedAs : (0, I.addBasePath)((0, A.addLocale)(new URL(o, location.href).pathname, $.locale), !0),
                                    n = r;
                ...
                async getRouteInfo(r) {
                    ...
                    try {
                        ...
                        if ((null == x ? void 0 : null == (M = x.effect) ? void 0 : M.type) === "rewrite") {
                            ...
                            if ((!E || u.includes(r)) && (O = r, o = x.effect.resolvedHref, l = {
                                ...
                                }, d = (0, C.removeBasePath)((0, _.normalizeLocalePath)(x.effect.parsedAs.pathname, this.locales).pathname), n = this.components[O], f.shallow && n && this.route === O && !y)) return {
                                ...n,
                                route: O
                            }
                        }
                        ...
                        let D = h || await this.fetchComponent(O).then(r => ({
                            ...
                            k = null == x ? void 0 : null == (I = x.response) ? void 0 : I.headers.get("x-middleware-skip"),
                        ...
                        return D.__N_SSP && L.dataHref && B && delete this.sdc[B], this.isPreview || !D.__N_SSG || E || fetchNextData(Object.assign({}, L, {
                            isBackground: !0,
                            persistCache: !1,
                ...
                async prefetch(r, n, o) {
                    ...
                    await this._bfl(n, y, o.locale, !0) && (this.components[u] = {
                        __appRouter: !0
                    }), await Promise.all([this.pageLoader._isSsg(M).then(n => !!n && fetchNextData({
                    ...
                    }).then(() => !1).catch(() => !1)), this.pageLoader[o.priority ? "loadPage" : "prefetch"](M)])
                }
                ...
                constructor(r, n, l, {
                    ...
                    this.sdc = {}, this.sbc = {}, this.isFirstPopStateEvent = !0, this._key = createKey(), this.onPopState = r => {
                        ...
                        (!this.isSsr || s !== (0, I.addBasePath)(this.asPath) || h !== (0, I.addBasePath)(this.pathname)) && (!this._bps || this._bps(l)) && this.change("replaceState", u, s, Object.assign({}, d, {
                    ...
                    this.components = {}, "/_error" !== r && (this.components[L] = {
                        Component: g,
                        initial: !0,
                        props: u,
                        err: _,
        ...
        78018: function (r) {
            var n, o, l, u, s, d, f, h, g, _, y, P, b, E, S, R, w, O, j, A, M, C, I, L, x, N, D, k, F, U, B, H, W, q, z, G, V, X, Y, K, Q, $, J, Z, ee, et;
            (n = {}).d = function (r, o) {
                ...
                if (r.cancelable) {
                    ...
                    }, addEventListener("pointerup", n, L), addEventListener("pointercancel", o, L)) : N(u, r)
                }
            }, F = function (r) {
